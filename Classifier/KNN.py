...
cv_clf = KNeighborsClassifier()###KNN
...
yscore_sum.to_csv('../output/yscore_KNN_cross.csv')
ytest=ytest[np.array(range(1,row)),:]
ytest_sum = pd.DataFrame(data=ytest)
ytest_sum.to_csv('../output/ytest_KNN_cross.csv')
...
data_csv.to_csv('../output/result_KNN_cross.csv')

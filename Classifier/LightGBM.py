...
parser.add_argument("--out_to_csv", type=str, default="../output/pos_neg_bigmodel_fusion.csv", help="the output file")
...
cv_clf=lgb.LGBMClassifier()###LightGBM
...
yscore_sum.to_csv('../output/yscore_LightGBM_cross.csv')
ytest=ytest[np.array(range(1,row)),:]
ytest_sum = pd.DataFrame(data=ytest)
ytest_sum.to_csv('../output/ytest_LightGBM_cross.csv')
...
data_csv.to_csv('../output/result_LightGBM_cross.csv')

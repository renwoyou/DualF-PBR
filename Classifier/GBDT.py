...
import argparse
##       pos_neg_152304_fusion_train       pos_neg_coding_bigmodel_fusion_train456      pos_neg_bigmodel_fusion_train456
...
yscore_sum.to_csv('../output/yscore_GBDT_cross.csv')
ytest=ytest[np.array(range(1,row)),:]
ytest_sum = pd.DataFrame(data=ytest)
ytest_sum.to_csv('../output/ytest_GBDT_cross.csv')
...
data_csv.to_csv('../output/result_GBDT_cross.csv')
